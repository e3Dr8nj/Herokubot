...
*/
                ...
                if((message.author.bot&& message.embeds[0]&&message.embeds[0].title&&message.embeds[0].description.startsWith('**Успешный Up!**'))||(message.content=='sup test'&&!message.author.bot )){ client.suped=true;
